...
export async function POST(request) {
  try {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Pesan baru telah diterima pada ${currentDate}:</p>
            
            <div class="info-row"><span class="info-label">Nama:</span> ${fullName}</div>
            <div class="info-row"><span class="info-label">Email:</span> <a href="mailto:${email}" style="color:#02382c;">${email}</a></div>
            <div class="info-row"><span class="info-label">WhatsApp:</span> <a href="${whatsappLink}" style="color:#02382c;">${whatsapp}</a></div>
            ...
            <div class="action-buttons">
              <a href="mailto:${email}?subject=Re: ${subject}" class="btn">Balas via Email</a>
              <a href="${whatsappLink}" class="btn btn-whatsapp">Hubungi via WhatsApp</a>
            </div>
    ...
    const textBody = `
      ...
      Untuk menghubungi via WhatsApp: ${whatsappLink}
